...
const Sidebar = ({ navigation }) => {
    ...
    return (
        <LinearGradient
            ...
            start={{ x: 0.4, y: 0.4 }}
        >
            <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 0.5, paddingHorizontal: 15, paddingBottom: 10, paddingTop: 20 }}>
            ...
            <View style={{ marginTop: 20 }}>
                ...
                >
                    <Image source={require('../assets/img/pin2.png')} style={styles.img1} />
                    <Text style={styles.text}>Music Plate / Sound Plate</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={styles.row}
                >
