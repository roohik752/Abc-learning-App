...
const ColoursNameWithImage = ({ route, navigation }) => {
  const { selectedColour } = route.params;
        ...
        <Container>
          ...
          <View style={styles.outer}>
            ...
            <View style={styles.box2}>
              <Text style={styles.text1}>{selectedColour.name}</Text>
              <TouchableOpacity onPress={handleSpeak} >
...
export default ColoursNameWithImage;
