...
const FemaleBodyPartsWithImage = ({ route, navigation }) => {
  ...
  const handleSpeak = () => {
    if (selectedBodyParts) {
      Tts.speak(selectedBodyParts.name)
          ...
          <View style={styles.outer}>
            <View style={styles.box1}>
              ...
              <TouchableOpacity onPress={handleSpeak} >
                <Image source={selectedBodyParts.img2} style={styles.image3} resizeMode='contain' />
              </TouchableOpacity>
            </View>
            <View style={styles.box2}>
              <Text style={styles.text1}>{selectedBodyParts.name}</Text>
              <TouchableOpacity onPress={handleSpeak} >
...
export default FemaleBodyPartsWithImage;
