...
import { VegetableQuiz, QuestionsAnswers } from '../../data/ques-ans1';

const VegetableQuestionAnswer = ({ route, navigation }) => {
  const [currentQuestionId, setCurrentQuestionId] = useState(0);
  const [selectedOption, setSelectedOption] = useState(null);

  // const getCurrentQuestion = (): QuestionsAnswers => {
  //   return VegetableQuiz.find((question) => question.id === currentQuestionId);
  // };
  ...
  const maxQuestionId = VegetableQuiz.length - 1;
...
export default VegetableQuestionAnswer;
